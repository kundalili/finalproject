...
export default function CardPregnant() {
  ...
  return (
    <>
        <div>
              <h2 className='text-[1.5rem]w-[500px] font-bold flex justify-center items-center p-[20px] text-left bg-vividBlue text-white rounded-t-lg shadow'>My Profile</h2>
