...
export default function Profile() {
  ...
  return (
   <div className='flex p-[20px] gap-[20px] justify-center items-center flex-col'>
        <TextField placeholder='Type your name' value={userToEdit.username} onChange={e => setUserToEdit({...userToEdit, username: e.target.value})} id="outlined-basic" label="Name" variant="outlined" />
